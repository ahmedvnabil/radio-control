// ZzFX (C) Frank Force - MIT - https://github.com/KilledByAPixel/ZzFX
// Sample-data generator only (offline-safe; does not auto-create AudioContext).
zzfxR = 44100;
zzfxV = 0.3;
zzfxG = (q=1,k=.05,c=220,e=0,t=0,u=.1,r=0,F=1,v=0,z=0,w=0,A=0,l=0,B=0,x=0,G=0,d=0,y=1,m=0,C=0)=>{
  ...
  for(h=e+m+t+u+d|0;a<h;Z[a++]=f)++K%(100*G|0)||(
    ...
    p=(c+=v+=z)*Math.sin(E*x-I),g+=p-p*B*(1-1E9*(Math.sin(a)+1)%2),E+=p-p*B*(1-1E9*(Math.sin(a)**2+1)%2),
    n&&++n>A&&(c+=w,D+=w,n=0),
    !l||++J%l||(c=D,v=H,n=n||1);
  return Z;
};
// ZzFXM (C) Keith Clark - MIT - https://github.com/keithclark/ZzFXM
